# 🛡️ Cybersecurity & Networking Homelab
...
- [ ] Run network enumeration/scanning exercises with Nmap
- [ ] Add a monitoring/logging layer (e.g. Security Onion or Splunk)
- [ ] Practice controlled exploitation scenarios with Metasploit
